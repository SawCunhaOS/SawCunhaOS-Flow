...
/** Lista paginada de motivos de ativação, com filtro opcional por {@code entityType} (UC-113). */
public interface FindAllReasonActivateUseCase {
    GetAllReasonActivateResponse execute(@NonNull PaginationFilter paginationFilter,
