...
/** Implementação de {@link FindContactTypeUseCase}. */
@Service
@RequiredArgsConstructor
@Slf4j
class FindContactTypeUseCaseBean implements FindContactTypeUseCase {

    private final ContactTypeService contactTypeService;

    @Override
    public ContactType execute(@NonNull Long id) {
        log.info("Find ContactType : {}", id);
        ContactTypeOutput contactTypeOutput = contactTypeService.findById(id);
