...
/** Implementação de {@link EnableReasonInactivateUseCase}. */
@Service
@RequiredArgsConstructor
@Slf4j
class EnableReasonInactivateUseCaseBean implements EnableReasonInactivateUseCase {

    private final ReasonInactivateService reasonInactivateService;

    @Override
    public void execute(@NonNull Long id) {
        log.info("Enable ReasonInactivate : {}", id);
        reasonInactivateService.enable(id);
    }
}
