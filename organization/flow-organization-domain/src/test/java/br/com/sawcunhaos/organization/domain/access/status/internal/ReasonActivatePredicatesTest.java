...
class ReasonActivatePredicatesTest {

    private static final QReasonActivate Q = QReasonActivate.reasonActivate;

    @Test
    void predicateCodeAndEntityTypeShouldCombineBothFields() {
        Predicate actual = ReasonActivatePredicates.predicateCodeAndEntityType("CODE", EntityType.COMPANY);
    ...
    void predicateCodeAndEntityTypeAndNotIdShouldExcludeGivenId() {
        Predicate actual = ReasonActivatePredicates.predicateCodeAndEntityTypeAndNotId("CODE", EntityType.COMPANY, 1L);
    ...
    void predicateEntityTypeAndActiveShouldOnlyFilterByActiveWhenEntityTypeIsNull() {
        Predicate actual = ReasonActivatePredicates.predicateEntityTypeAndActive(null, true);
    ...
    void predicateEntityTypeAndActiveShouldOnlyFilterByEntityTypeWhenActiveIsNull() {
        Predicate actual = ReasonActivatePredicates.predicateEntityTypeAndActive(EntityType.COMPANY, null);
    ...
    void predicateEntityTypeAndActiveShouldBeEmptyWhenBothAreNull() {
        Predicate actual = ReasonActivatePredicates.predicateEntityTypeAndActive(null, null);
