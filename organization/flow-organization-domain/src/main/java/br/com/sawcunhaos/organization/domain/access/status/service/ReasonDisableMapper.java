...
/**
 * MapStruct: {@link ReasonDisable} (entidade JPA) → {@link ReasonDisableOutput} (dto de domínio).
 */
@Mapper(componentModel = "spring")
public interface ReasonDisableMapper {

    ReasonDisableOutput toReasonDisableOutput(ReasonDisable reasonDisable);
