...
/** Implementação de {@link DisableReasonActivateUseCase}. */
@Service
@RequiredArgsConstructor
@Slf4j
@Transactional(rollbackFor = ScosException.class)
class DisableReasonActivateUseCaseBean implements DisableReasonActivateUseCase {

    private final ReasonActivateService reasonActivateService;

    @Override
    public void execute(@NonNull Long id) {
        log.info("Disable ReasonActivate : {}", id);
        reasonActivateService.disable(id);
    }
}
