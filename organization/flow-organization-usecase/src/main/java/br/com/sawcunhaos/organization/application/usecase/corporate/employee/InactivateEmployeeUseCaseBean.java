...
/** Implementação de {@link InactivateEmployeeUseCase} — delega a {@link EmployeeService#inactivate}. */
@Service
@RequiredArgsConstructor
@Slf4j
@Transactional(rollbackFor = ScosException.class)
class InactivateEmployeeUseCaseBean implements InactivateEmployeeUseCase {
