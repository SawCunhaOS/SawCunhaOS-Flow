...
/** Implementação de {@link EnableReasonActivateUseCase}. */
@Service
@RequiredArgsConstructor
@Slf4j
@Transactional(rollbackFor = ScosException.class)
class EnableReasonActivateUseCaseBean implements EnableReasonActivateUseCase {

    private final ReasonActivateService reasonActivateService;

    @Override
    public void execute(@NonNull Long id) {
        log.info("Enable ReasonActivate : {}", id);
        reasonActivateService.enable(id);
    }
}
