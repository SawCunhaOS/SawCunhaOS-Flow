...
/** Implementação de {@link DisableReasonInactivateUseCase}. */
@Service
@RequiredArgsConstructor
@Slf4j
@Transactional(rollbackFor = ScosException.class)
class DisableReasonInactivateUseCaseBean implements DisableReasonInactivateUseCase {

    private final ReasonInactivateService reasonInactivateService;

    @Override
    public void execute(@NonNull Long id) {
        log.info("Disable ReasonInactivate : {}", id);
        reasonInactivateService.disable(id);
    }
}
