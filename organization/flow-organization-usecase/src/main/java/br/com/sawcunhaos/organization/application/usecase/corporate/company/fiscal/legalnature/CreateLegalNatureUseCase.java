...
/** Cria uma nova natureza jurídica (UC-094). */
public interface CreateLegalNatureUseCase {
    LegalNature execute(@NonNull CreateLegalNatureRequest createLegalNatureRequest);
}
