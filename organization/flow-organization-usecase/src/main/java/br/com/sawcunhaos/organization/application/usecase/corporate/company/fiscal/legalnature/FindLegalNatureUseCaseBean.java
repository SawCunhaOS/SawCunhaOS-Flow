...
/** Implementação de {@link FindLegalNatureUseCase}. */
@Service
@RequiredArgsConstructor
@Slf4j
@Transactional(readOnly = true)
class FindLegalNatureUseCaseBean implements FindLegalNatureUseCase {

    private final LegalNatureService legalNatureService;

    @Override
    public LegalNature execute(@NonNull Long id) {
        log.info("Find legal nature by id: {}", id);
        return LegalNatureApiMapper.toApiLegalNature(legalNatureService.findById(id));
    }
}
