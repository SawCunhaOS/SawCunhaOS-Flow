...
/** Implementação de {@link DisableReasonDisableUseCase}. */
@Service
@RequiredArgsConstructor
@Slf4j
@Transactional(rollbackFor = ScosException.class)
class DisableReasonDisableUseCaseBean implements DisableReasonDisableUseCase {

    private final ReasonDisableService reasonDisableService;

    @Override
    public void execute(@NonNull Long id) {
        log.info("Disable ReasonDisable : {}", id);
        reasonDisableService.disable(id);
    }
}
