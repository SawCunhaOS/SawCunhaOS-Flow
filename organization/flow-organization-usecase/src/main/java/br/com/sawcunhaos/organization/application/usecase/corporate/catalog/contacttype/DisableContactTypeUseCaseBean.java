...
/** Implementação de {@link DisableContactTypeUseCase}. */
@Service
@RequiredArgsConstructor
@Slf4j
@Transactional(rollbackFor = ScosException.class)
class DisableContactTypeUseCaseBean implements DisableContactTypeUseCase {

    private final ContactTypeService contactTypeService;

    @Override
    public void execute(@NonNull Long id) {
        log.info("Disable ContactType : {}", id);
        contactTypeService.disable(id);
    }
}
