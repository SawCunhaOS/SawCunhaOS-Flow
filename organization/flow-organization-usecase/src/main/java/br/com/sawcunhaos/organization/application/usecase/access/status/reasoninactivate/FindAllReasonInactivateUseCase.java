...
/** Lista paginada de motivos de inativação, com filtro opcional por {@code entityType} (UC-119). */
public interface FindAllReasonInactivateUseCase {
    GetAllReasonInactivateResponse execute(@NonNull PaginationFilter paginationFilter,
