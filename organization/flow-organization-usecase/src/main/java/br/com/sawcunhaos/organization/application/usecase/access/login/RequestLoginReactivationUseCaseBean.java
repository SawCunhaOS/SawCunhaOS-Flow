...
class RequestLoginReactivationUseCaseBean implements RequestLoginReactivationUseCase {

    private final LoginService loginService;

    @Override
    public void execute(@NonNull Long loginId) {
        log.info("Request Login Reactivation: {}", loginId);
        loginService.requestReactivation(loginId);
    }
}
