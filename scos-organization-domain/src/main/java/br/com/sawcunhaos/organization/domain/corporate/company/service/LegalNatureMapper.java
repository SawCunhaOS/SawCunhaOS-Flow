...
/**
 * MapStruct: {@link LegalNature} (entidade JPA) → {@link LegalNatureOutput} (dto de domínio).
 */
@Mapper(componentModel = "spring")
public interface LegalNatureMapper {

    LegalNatureOutput toLegalNatureOutput(LegalNature legalNature);
