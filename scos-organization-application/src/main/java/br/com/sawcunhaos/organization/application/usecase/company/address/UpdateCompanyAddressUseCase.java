...
/**
 * UseCase: Atualizar endereço de empresa
 *
 * PUT /v1/companies/{companyId}/addresses/{addressId}
 */
@Component
@RequiredArgsConstructor
@Slf4j
@Transactional(rollbackFor = ScosException.class, noRollbackFor = ScosNoRollbackException.class)
public class UpdateCompanyAddressUseCase {

    private final CompanyRepository companyRepository;
    private final CompanyAddressRepository companyAddressRepository;

    public void execute(Long companyId, Long addressId, CompanyAddressDTO addressDTO) {
        log.info("Updating company address: companyId={}", companyId);
        ...
        log.info("Company address updated successfully");
    }
}
