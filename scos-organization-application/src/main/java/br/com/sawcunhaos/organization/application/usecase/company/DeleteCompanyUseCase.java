...
public class DeleteCompanyUseCase implements ScosBaseUseCase<Long, Void> {
    ...
    public Void execute(@NonNull Long companyId) {
        ...
        companyDomainService.validateCompanyHasDependenciesValidation(companyId);
        companyDomainService.validateRootCompanyConstraintValidation(companyId);
