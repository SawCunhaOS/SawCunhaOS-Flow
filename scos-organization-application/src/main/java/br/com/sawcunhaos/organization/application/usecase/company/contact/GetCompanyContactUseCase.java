...
/**
 * UseCase: Obter contato de empresa
 *
...
public class GetCompanyContactUseCase {

    private final CompanyRepository companyRepository;
    private final CompanyContactRepository companyContactRepository;

    public CompanyContactDTO execute(Long companyId, Long contactId) {
        log.info("Getting company contact: companyId={}, contactId={}", companyId, contactId);
