...
/**
 * UseCase: Deletar contato de empresa
 *
...
public class DeleteCompanyContactUseCase {

    private final CompanyRepository companyRepository;
    private final CompanyContactRepository companyContactRepository;

    public void execute(Long companyId, Long contactId) {
        log.info("Deleting company contact: companyId={}, contactId={}", companyId, contactId);
        ...
        // 2. Deletar contato
        companyContactRepository.deleteByCompanyIdAndId(companyId, contactId);

        log.info("Company contact deleted successfully: id={}", contactId);
    }
}
